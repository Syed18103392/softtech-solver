		...
		public function load_config() {
			...
			$sections = array(
				...
				array(
					...
					'fields' => array(
						array(
							'title' => __('Facebook', 'mediacenter'),
							'subtitle' => __('<em>Type your Facebook profile URL here.</em>', 'mediacenter'),
							'id' => 'facebook_link',
							'type' => 'text',
							'default' => 'https://www.facebook.com/',
						),
						array(
							'title' => __('Twitter', 'mediacenter'),
							'subtitle' => __('<em>Type your Twitter profile URL here.</em>', 'mediacenter'),
							'id' => 'twitter_link',
							'type' => 'text',
							'default' => 'http://twitter.com/',
						),
						array(
							'title' => __('Pinterest', 'mediacenter'),
							'subtitle' => __('<em>Type your Pinterest profile URL here.</em>', 'mediacenter'),
							'id' => 'pinterest_link',
							'type' => 'text',
							'default' => 'http://www.pinterest.com/',
						),
						array(
							'title' => __('LinkedIn', 'mediacenter'),
							'subtitle' => __('<em>Type your LinkedIn profile URL here.</em>', 'mediacenter'),
							'id' => 'linkedin_link',
							'type' => 'text',
						),
						array(
							'title' => __('Google+', 'mediacenter'),
							'subtitle' => __('<em>Type your Google+ profile URL here.</em>', 'mediacenter'),
							'id' => 'googleplus_link',
							'type' => 'text',
						),
						array(
							'title' => __('RSS', 'mediacenter'),
							'subtitle' => __('<em>Type your RSS Feed URL here.</em>', 'mediacenter'),
							'id' => 'rss_link',
							'type' => 'text',
						),

						array(
							'title' => __('Tumblr', 'mediacenter'),
							'subtitle' => __('<em>Type your Tumblr URL here.</em>', 'mediacenter'),
							'id' => 'tumblr_link',
							'type' => 'text',
						),

						array(
							'title' => __('Instagram', 'mediacenter'),
							'subtitle' => __('<em>Type your Instagram profile URL here.</em>', 'mediacenter'),
							'id' => 'instagram_link',
							'type' => 'text',
						),

						array(
							'title' => __('Youtube', 'mediacenter'),
							'subtitle' => __('<em>Type your Youtube profile URL here.</em>', 'mediacenter'),
							'id' => 'youtube_link',
							'type' => 'text',
						),

						array(
							'title' => __('Vimeo', 'mediacenter'),
							'subtitle' => __('<em>Type your Vimeo profile URL here.</em>', 'mediacenter'),
							'id' => 'vimeo_link',
							'type' => 'text',
						),

						array(
							'title' => __('Dribbble', 'mediacenter'),
							'subtitle' => __('<em>Type your Dribble profile URL here.</em>', 'mediacenter'),
							'id' => 'dribbble_link',
							'type' => 'text',
						),

						array(
							'title' => __('Stumble Upon', 'mediacenter'),
							'subtitle' => __('<em>Type your Stumble Upon profile URL here.</em>', 'mediacenter'),
